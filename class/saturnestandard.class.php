...
/**
 * \file    class/saturnestandard.class.php
 * \ingroup saturne
 * \brief   This file is a CRUD class file for SaturneStandard (Create/Read/Update/Delete)
 */
...
/**
 * Class for SaturneStandard
 */
class SaturneStandard extends SaturneObject
{
    /**
     ...
     */
    public $element = 'saturnestandard';

    /**
     * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management (so extrafields know the link to the parent table)
     */
    public $table_element = 'saturne_object_standard';
    ...
    /**
     * @var string Name of icon for saturnestandard. Must be a 'fa-xxx' fontawesome code (or 'fa-xxx_fa_color_size') or 'saturnestandard@saturne' if picto is file 'img/object_saturnestandard.png'
     */
    ...
    public $fields = [
        ...
        'status'         => ['type' => 'smallint',     'label' => 'Status',           'enabled' => 1, 'position' => 70, 'notnull' => 1, 'visible' => -2, 'index' => 1, 'default' => 1],
