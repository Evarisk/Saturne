...
/**
 * \file        class/signature.class.php
 * \ingroup     saturne
 * \brief       This file is a CRUD class file for Signature (Create/Read/Update/Delete)
 */
 ...
 * Class for Signature
 */
class Signature extends CommonObject
{
	/**
	 ...
	 */
	public $picto = 'object_signature@saturne';
	...
	public $fields = [
		...
		'entity'               => ['type' => 'integer', 'label' => 'Entity', 'enabled' => '1', 'position' => 10, 'notnull' => 1, 'visible' => -1,],
		'date_creation'        => ['type' => 'datetime', 'label' => 'DateCreation', 'enabled' => '1', 'position' => 20, 'notnull' => 1, 'visible' => -2,],
		'tms'                  => ['type' => 'timestamp', 'label' => 'DateModification', 'enabled' => '1', 'position' => 30, 'notnull' => 0, 'visible' => -2,],
		'import_key'           => ['type' => 'integer', 'label' => 'ImportId', 'enabled' => '1', 'position' => 40, 'notnull' => 1, 'visible' => -2,],
		...
		'element_id'           => ['type' => 'integer', 'label' => 'ElementType', 'enabled' => '1', 'position' => 140, 'notnull' => 1, 'visible' => 1,],
		'element_type'         => ['type' => 'varchar(50)', 'label' => 'ElementType', 'enabled' => '1', 'position' => 150, 'notnull' => 0, 'visible' => 1,],
