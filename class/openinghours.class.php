...
class OpeningHours extends CommonObject
{
	...
	public $fields = [
		...
		'status'        => ['type' => 'smallint', 'label' => 'Status', 'enabled' => '1', 'position' => 40, 'notnull' => 0, 'visible' => 0],
        ...
        'fk_user_modif' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserModif', 'enabled' => '1', 'position' => 150, 'notnull' => -1, 'visible' => 0, 'foreignkey' => 'user.rowid'],
    ];
